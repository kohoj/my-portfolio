<template>
	...
	<div
		id="app"
		class="flex flex-col w-full h-full absolute inset-0 m-auto opacity-90"
	>
...
@import url('https://fonts.googleapis.com/css?family=Bakbak+One:400');

#app {
	font-family: 'Catamaran', Avenir, Helvetica, Arial, sans-serif;
